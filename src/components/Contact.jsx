  ...
  return (
    <section id="contact" className="contact section">
      <div className="container container--narrow">
        <div ref={contentRef} className={`contact__content ${contentVisible ? "revealed" : ""}`}>
          ...
          <p className="contact__subtitle">
            Whether it's an AI-powered system, a real-time dashboard, or
            something the world hasn't seen yet — I'm always open to
            conversations that push boundaries.
          </p>
          ...
          <div className="contact__blocks">
            ...
            >
              ...
              <div className="contact__info-text">
                <span className="contact__info-value">{contact.email}</span>
                <span className="contact__info-hint">
                  {copied ? "✓ Copied to clipboard!" : "Click to copy"}
                </span>
              </div>
              <div className="contact__info-action">
                {copied ? (
            ...
            >
              ...
              <div className="contact__info-text">
                <span className="contact__info-value">{contact.phone}</span>
                <span className="contact__info-hint">Call or WhatsApp</span>
              </div>
              <div className="contact__info-action">
